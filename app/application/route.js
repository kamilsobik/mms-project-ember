...
export default class ApplicationRoute extends Route {
  ...
  async beforeModel() {
    ...
    const request1 = {
      ...
      downtime: '30',
      createdAt: new Date(2023, 0, 12, 16, 20),
      status: 'closed',
    ...
    const request2 = {
      ...
      downtime: '60',
      createdAt: new Date(2023, 0, 15, 11, 37),
      status: 'closed',
    ...
    const request3 = {
      ...
      title: 'Problem with air cylinder',
      downtime: '120',
      createdAt: new Date(2023, 0, 7, 11, 11),
      status: 'closed',
    ...
    const request4 = {
      ...
      downtime: '75',
      createdAt: new Date(2023, 0, 25, 23, 1),
      status: 'closed',
    ...
    const request5 = {
      ...
      downtime: '30',
      createdAt: new Date(2023, 0, 26, 37, 34),
      status: 'closed',
